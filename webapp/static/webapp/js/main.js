...
(function($) {
    ...
    hero_s.owlCarousel({
        ...
        animateOut: 'fadeOut',
    	animateIn: 'fadeIn',
        navText: ['<img src="/static/webapp/img/angle-left-w.png" alt="" type="png">', '<img src="/static/webapp/img/angle-rignt.png" alt="" type="png">'],
        smartSpeed: 1200,
        autoHeight: false,
	...
	$('.gallery-single-slider').owlCarousel({
        ...
        items: 1,
        dots: false,
        navText: ['<img src="/static/webapp/img/angle-left.png" alt="" type="png">', '<img src="/static/webapp/img/angle-rignt-w.png" alt="" type="png">'],
	});
